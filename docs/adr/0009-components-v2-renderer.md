...
3. 画像は Discord の添付として送る（[ADR 0005](0005-media-delivery.md)）ので、
   `attachment://` 参照が使えること
...
- `MediaGalleryBuilder` に最大10 item を載せ、`attachment://<name>` で添付を参照する
...
- 送信前に硬いアサート（添付 ≤10、gallery item ≤10、embed ≤10）を置き、
